...
из указателей.  Эта система показана на [схеме link_map](refs/link_map.png)
(фиг. 1.1)
...
```
[Функция без сокращений](refs/add_fixup_full.c)
...
промежутки между используемыми полями fake_link_map. Построенная структура
показана на схеме [фиг. 1.2](refs/fake_link_map.png)
